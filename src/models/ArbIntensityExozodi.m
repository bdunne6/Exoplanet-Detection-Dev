classdef SimpleExozodi1 < ImageComponent
    ...
    properties
        ...
        intensity_function %1D function that describes the radially symmetric intensity
    end
    ...
    properties (Hidden = true,Constant=true)
        ...
        nested_models = {'intensity_function'}
    end
    
    methods
        function obj = SimpleExozodi1(img_size)
...
%             img_comp = conv2(img_comp,obj.psf,'same');
        end
