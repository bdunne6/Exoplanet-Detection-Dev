classdef LMOptimizer < Optimizer
    ...
    methods
        function obj = LMOptimizer(varargin)
            %LMOPTIMIZER Construct an instance of this class
            %   Detailed explanation goes here
            if numel(varargin)==3
        ...
        function obj_fun = get_objective_function(obj,i_valid,loss_function,loss_threshold)
            ...
            switch loss_function
                ...
                case 'absolute'
                    obj_fun = @(x) sqrt(LossFunctions.absolute_loss(get_selected_residuals(x),loss_threshold));
                case 'none'
